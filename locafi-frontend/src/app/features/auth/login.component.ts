    ...
    <main class="min-h-screen bg-transparent text-slate-100">
      <div class="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-10">
        <section class="rounded-3xl border border-slate-700/70 bg-slate-900/80 p-6 shadow-neo">
          <p class="text-xs uppercase tracking-[0.22em] text-slate-400">Welcome back</p>
          <h1 class="mt-1 text-2xl font-semibold tracking-tight text-white">Login to LocaFi</h1>
          ...
          <p class="mt-4 text-xs text-slate-400">
            New here?
            <a routerLink="/signup" class="text-slate-200 underline">Create an account</a>
          </p>
        </section>
      </div>
    </main>
